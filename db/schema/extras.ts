import { pgTable, uuid, text, integer, boolean, jsonb, timestamp, date, uniqueIndex } from 'drizzle-orm/pg-core'
...
export const calendarEvents = pgTable('calendar_events', {
  ...
  reminderMinutes: integer('reminder_minutes').array().default([]),
  recurrenceRule: text('recurrence_rule'),
  recurrenceParentId: uuid('recurrence_parent_id'),
  recurrenceExceptionDate: date('recurrence_exception_date'),
