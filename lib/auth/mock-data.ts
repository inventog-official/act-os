...
let mockLeads = [
  { id: 'lead-1', first_name: 'Sarah', last_name: 'Chen', email: 'sarah@acmecorp.com', phone: '+1 555-0101', job_title: 'CEO', company_id: null, company_name: 'Acme Corp', website: 'https://acmecorp.com', industry: 'Technology', lead_source: 'website', priority: 'high', status: 'new', pipeline_stage_id: 'stage-1', estimated_deal_value: 25000, expected_close_date: '2025-08-15', description: 'Interested in enterprise plan', notes: null, organization_id: MOCK_ORG_ID, workspace_id: null, assigned_to: null, created_by: MOCK_USER_ID, updated_by: null, created_at: new Date(Date.now() - 3600000).toISOString(), updated_at: new Date(Date.now() - 3600000).toISOString(), deleted_at: null },
...
let mockCompanies = [
  { id: 'company-1', name: 'Acme Corp', industry: 'Technology', employee_count: 250, revenue: 50000000, address_line1: '123 Main St', address_line2: null, city: 'San Francisco', state: 'CA', zip: '94105', country: null, website: 'https://acmecorp.com', phone: '+1 555-1000', email: 'info@acmecorp.com', gst_number: null, logo_url: null, description: 'Leading tech company', organization_id: MOCK_ORG_ID, workspace_id: null, assigned_to: null, created_by: MOCK_USER_ID, updated_by: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), deleted_at: null },
...
let mockDeals = [
  { id: 'deal-1', name: 'Acme Corp Enterprise', deal_value: 25000, probability: 10, pipeline_id: MOCK_PIPELINE_ID, pipeline_stage_id: 'stage-1', lead_id: 'lead-1', company_id: 'company-1', contact_id: null, expected_close_date: '2025-08-15', actual_close_date: null, notes: null, organization_id: MOCK_ORG_ID, workspace_id: null, assigned_to: null, created_by: MOCK_USER_ID, updated_by: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), deleted_at: null },
...
let mockTasks = [
  { id: 'task-1', title: 'Follow up with Acme Corp proposal', description: 'Send revised proposal with updated pricing', status: 'pending', priority: 'high', due_date: new Date(Date.now() + 86400000).toISOString(), reminder_at: null, is_recurring: false, recurring_interval: null, lead_id: 'lead-1', company_id: null, contact_id: null, deal_id: null, organization_id: MOCK_ORG_ID, workspace_id: null, assigned_to: null, created_by: MOCK_USER_ID, updated_by: null, completed_at: null, created_at: new Date().toISOString(), updated_at: new Date().toISOString(), deleted_at: null },
